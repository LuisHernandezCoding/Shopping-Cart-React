        ...
        <div className="container">
          <div className="columns is-centered">
            <div className="column is-half is-flex is-flex-direction-column is-justify-content-center">
              <h1 className="title is-size-1 has-text-centered has-text-weight-bold has-text-warning animate__animated animate__delay-1s animate__zoomIn">Welcome To Pizza Planet</h1>
